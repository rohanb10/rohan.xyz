...
$(".project-list a").click(function() {
	...
	if(project != $(".laptop-screen").data("screen")) {
		...
		$(".project-description").hide('fade',802);
		var btn = $(this);
		...
		setTimeout(function() {
			...
			//show new screen
			$(".iphone-screen").show('slide', { direction: "left"},800);
			$(".laptop-screen").show('slide', { direction: "left"},800);
			//change to new button
			btn.css('box-shadow', 'inset 250px 0 0 0 #31302B');
			btn.css('color', '#F3F3F3');
			
			//change descriptions
			$(".project-description").show('fade',800);
			$(".project-github").show('fade',800);
			if(project == "sl") {

var jobList = [
  ...
  },
  {
    ...
    date:"6 semesters",
    text:"<div><strong>CSE 131 - Computer Science 1</strong></div><div>An introductory Computer Science course taught to over 500 students every semester. It covers many fundamental programming concepts including algorithms, iteration and recursion, inheritance, object oriented programming and some simple data structures. My duties include:</div><br><div><strong>CSE330S - Rapid Prototype Development and Creative Programming</strong></div><div>A web development course that teaches many different skills including setting up Apache servers, databases and web security. Additionally, students are taught PHP, JavaScript, Python, AJAX, MEAN Stack, Socket.IO and the frustration that comes along with debugging.</div><br><div>As a TA for both these courses, my duties include:</div><ul><li>Holding weekly lab and studio sessions for around 30-50 students</li><li>Conducting weekly office hours for more individualized help</li><li>Grading of labs, studios, exams and extensions</li></ul>"
  },
  {
    id:"zappos",
    name:"Zappos",
...
var projectList = [
  {
    ...
    name:"Kraudesorce",
    url:"",
    github:"https://github.com/yashdalal/kraudesorce",
    desription:"An app that estimates the number of people at dining halls on WUSTL's campus at any given time. Data is gathered from wifi routers across campus and an iPhone app. This project is still under active development."
  },
  {
    id:"sl",
    name:"Studlife",
  ...
  {
    id:"sl-housing",
    name:"Studlife Housing Guide",
    url:"http://studlife.com/housing",
    github:"https://github.com/rohanb10/studlife",
    desription:"A comprehensive housing guide for all official campus living options for Washington University. Check out the website and source code below."
  },
  {
    id:"sl-whowon",
    name:"Studlife Who Won 15-16",
    url:"http://studlife.com/whowon1516",
    github:"https://github.com/rohanb10/studlife",
    desription:"An end of year bracket recapping the 32 most notable events on WUSTL's campus in 2015-16. This piece was split into 5 parts, and had a staggered release on the website over the course of a week."
  },
  {
    id:"llinder",
    name:"Llinder",
